...
<div class="card mb-3" style="max-width: 540px;margin: 5%;">
    <div class="row g-0">
        <div class="col-md-4">
            <img src="{{asset('images/'.$product->image)}}" style="height: 100%;" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-8">
            <div class="card-body">
                ...
                <a href="{{route('product.index')}}" class="card-link"><i class="fa fa-arrow-left"
